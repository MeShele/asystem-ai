...
export default function TgClientProjectsPage() {
              ...
              >
                <div className="flex items-start justify-between mb-2 gap-2">
                  ...
                  <div className="text-right flex-shrink-0">
                    {total > 0 && (
                      <>
                        <div className="text-[10px] uppercase text-text-muted tracking-wider">оплачено</div>
                        <div className="text-sm font-mono font-bold text-green-600">
                          ${paid.toLocaleString("ru-RU")}<span className="text-[10px] text-text-muted">/${total.toLocaleString("ru-RU")}</span>
                        </div>
                      </>
                    )}
                  </div>
