    ...
    <section id="hero" className="px-6 lg:px-12 py-20 lg:py-32">
      ...
      >
        ...
        >
          ...
          <strong style={{ color: "#0a0a0a" }}>15% с базы</strong> сразу и{" "}
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "15% от базы — сразу после оплаты клиентом. Плюс 50% от любой наценки, которую ты сам назначил.",
  },
];
...
const FAQ = [
  {
    q: "Откуда 15% с базы? Это честно?",
    a: "Мы закладываем комиссию в маржу с самого начала. Ты не «отнимаешь» у нас — это доля, которую мы специально резервируем для партнёров. Без партнёров мы не нашли бы этого клиента.",
  },
  {
  ...
  },
  {
    ...
    a: "15% с базы приходит в течение 3 рабочих дней после оплаты клиентом. 50% наценки — через 5 рабочих дней после полной оплаты проекта. На карту, USDT или наличными.",
  },
  {
    q: "Нужен ли договор?",
