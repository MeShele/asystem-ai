...
const sections = [
  ...
  { title: "4. Ваши права", text: "Вы можете запросить удаление ваших данных в любой момент, написав на asystem.teamwork@gmail.com." },
  { title: "5. Контакты", text: "По вопросам конфиденциальности: asystem.teamwork@gmail.com" },
];
